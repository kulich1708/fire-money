 ...
 */
    ...
    (() => {
        "use strict";
        const modules = {};
        if (!localStorage.getItem("fire-money")) localStorage.setItem("fire-money", JSON.stringify({
            login: "false"
        }));
        function isWebp() {
        ...
        let _slideUp = (target, duration = 500, showmore = 0) => {
            if (!target.classList.contains("_slide")) {
                ...
                if (target.closest(".page__slider")) {
                    const slider = target.closest(".page__slider");
                    if (slider && slider.querySelector(".swiper-slide-active")) {
                        let firstHeight = 0;
                        const firstChildElements = slider.querySelector(".swiper-slide-active").children;
                        ...
                        slider.style.transitionProperty = "height";
                        slider.style.height = firstHeight + "px";
                        slider.offsetHeight;
                        slider.style.overflow = "hidden";
                        slider.style.height = firstHeight - target.offsetHeight + "px";
                    }
                }
                window.setTimeout((() => {
        ...
        function spollers() {
            ...
            if (spollersArray.length > 0) {
                ...
                function setSpollerAction(e) {
                    ...
                    if (el.closest("[data-spoller]")) {
                        ...
                        if (!spollersBlock.querySelectorAll("._slide").length) {
                            if (oneSpoller && !spollerTitle.closest(".spollers__item").classList.contains("_spoller-active")) hideSpollersBody(spollersBlock);
                            spollerTitle.closest(".spollers__item").classList.toggle("_spoller-active");
                ...
                function hideSpollersBody(spollersBlock) {
                    const spollerActiveTitle = spollersBlock.querySelector("._spoller-active [data-spoller]");
                    const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                    if (spollerActiveTitle && !spollersBlock.querySelectorAll("._slide").length) {
                        spollerActiveTitle.closest(".spollers__item").classList.remove("_spoller-active");
                ...
                if (spollersClose.length) document.addEventListener("click", (function(e) {
                    ...
                    if (!el.closest("[data-spollers]")) spollersClose.forEach((spollerClose => {
                        ...
                        const spollerSpeed = spollersBlock.dataset.spollersSpeed ? parseInt(spollersBlock.dataset.spollersSpeed) : 500;
                        spollerClose.closest(".spollers__item").classList.remove("_spoller-active");
        ...
        function menuInit() {
            ...
            if (menuLinks.length) for (let i = 0; i < menuLinks.length; i++) {
            ...
            window.addEventListener("load", (function(e) {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        ...
                        hiddenHeight += +parseInt(window.getComputedStyle(showMoreContent).rowGap) * (showMoreTypeValue - 1);
                    } else {
        ...
        function inputTel() {
            ...
            inputTypeTel.forEach((e => {
                let regex;
                if (e.hasAttribute("data-symbol")) regex = /[A-Za-z]/g; else regex = /\D/g;
                e.oninput = function() {
        ...
        let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0, e) => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    inputMaxLength = inputMaxLength ? inputMaxLength : 1 / 0;
            ...
            addError(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.error) formRequiredItem.parentElement.parentElement.insertAdjacentHTML("beforeend", `<div class="form__error">${formRequiredItem.dataset.error}</div>`);
            },
            removeError(formRequiredItem) {
                formRequiredItem.classList.remove("_form-error");
                formRequiredItem.parentElement.parentElement.classList.remove("_form-error");
                if (formRequiredItem.parentElement.parentElement.querySelector(".form__error")) formRequiredItem.parentElement.parentElement.removeChild(formRequiredItem.parentElement.parentElement.querySelector(".form__error"));
            },
            formClean(form) {
                form.reset();
                setTimeout((() => {
        ...
        function formSubmit(options = {
            ...
            async function formSubmitAction(form, e) {
                ...
                if (error === 0) {
                    ...
                    if (buttonSliderActive) {
                        e.preventDefault();
                        buttonSliderActive.click();
                    }
                } else {
                    e.preventDefault();
        ...
        function initSliders() {
            if (document.querySelector(".page__slider")) window.applicationSlider = new core(".page__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    nextEl: ".form__button-slider_next"
                },
                on: {}
            });
        }
        ...
        function rangeInit() {
            ...
            window.addEventListener("load", (e => {
                function positioningTooltips(slider) {
                    ...
                    sliderTooltips.forEach((sliderTooltip => {
                        ...
                        if (sliderTooltip.getBoundingClientRect().left - basePositionLeft < sliderTooltip.offsetWidth / 2) {
                            ...
                            if (newValue >= 0) sliderTooltip.style.left = [ tooltipStyleLeft[0], tooltipStyleLeft[1].replace(parseFloat(tooltipStyleLeft[1]), newValue) ].join(" + "); else sliderTooltip.style.left = [ tooltipStyleLeft[0], -tooltipStyleLeft[1].replace(parseFloat(tooltipStyleLeft[1]), newValue) ].join(" - ");
                            ...
                            if (newValue >= 0) sliderTooltip.style.left = [ tooltipStyleLeft[0], tooltipStyleLeft[1].replace(parseFloat(tooltipStyleLeft[1]), newValue) ].join(" - "); else sliderTooltip.style.left = [ tooltipStyleLeft[0], -tooltipStyleLeft[1].replace(parseFloat(tooltipStyleLeft[1]), newValue) ].join(" + ");
                        } else sliderTooltip.style.left = "calc(50% + 0px)";
                    }));
                }
                const sumSlider = document.querySelector("#sum");
                if (sumSlider) {
                    sumSlider.getAttribute("data-from");
                    sumSlider.getAttribute("data-to");
                ...
                if (termSlider) {
                    termSlider.getAttribute("data-from");
                    termSlider.getAttribute("data-to");
                    document.getElementById("values-slider");
                ...
                function setProgressSlider(sliderName) {
                    ...
                    currentSlideIndex.forEach(((e, i) => {
                        if (e.classList.contains("swiper-slide-active")) currentSlideIndex = i;
                    }));
                    if (currentSlideIndex !== 0) document.querySelector(".header").classList.add("header_min");
                    if (steps) {
                    ...
                    if (progressBottom) progressBottom.innerHTML = Math.round(100 / quantSlide);
                    const progressSubtitle = document.querySelector(".swiper-slide-active .top-content__subtitle span");
                    if (progressSubtitle) progressSubtitle.innerHTML = Math.round(100 / quantSlide * (currentSlideIndex + 1)) + "%";
                    let progressPage = 0;
                    ...
                    if (formElements) {
                        formElements = formElements.filter((e => {
                            if (e.tagName == "BUTTON") ; else if (e.tagName == "INPUT" && !e.hasAttribute("data-required")) ; else return e;
                        }));
                        ...
                        for (let i = 0; i < spollers.length; i++) {
                            ...
                            if (spollerProgress) spollerProgress.innerHTML = Math.round(100 / quantSlide / formElements.length * formElementsSpoller.length) + "%";
                        }
                        formElements.forEach(((e, i) => {
                            if (e.tagName == "INPUT" && e.type != "checkbox" && e.value != "" || e.tagName == "INPUT" && e.type == "checkbox" && e.checked || e.tagName == "SELECT" && e.hasAttribute("multiple") && e.querySelector('[selected="selected"]') || e.tagName == "SELECT" && !e.hasAttribute("multiple") && e.closest(".select").querySelector(".select__title")) progressPage += 100 / quantSlide / formElements.length;
                        }));
                ...
                if (progressSliders.length) for (let i = 0; i < progressSliders.length; i++) {
                    ...
                    document.documentElement.addEventListener("click", (e => {
                        if (e.target.closest(".select")) setTimeout((() => {
                            setProgressSlider(progressSlider);
                        }), 100);
                    }));
                ...
                if (progressSlidersLigth.length) for (let i = 0; i < progressSlidersLigth.length; i++) {
            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        gotoBlock(gotoLinkSelector, noHeader, gotoSpeed, offsetTop, e);
                    }
        ...
        function initializeClock(id, endtime) {
            ...
            if (clock) {
                ...
                if (hoursSpan && hoursSpan.hasAttribute("data-span")) {
                    hoursSpan = hoursSpan.querySelectorAll("span");
                ...
                if (countdownNum) {
                    ...
                    if (clockLink) clockLink.classList.remove("_active");
                }
            }
            function updateClock() {
                var t = getTimeRemaining(endtime);
                if (daysSpan) if (daysSpan.constructor.name == "NodeList") daysSpan.forEach(((element, item) => {
                    element.innerHTML = t.days.split("")[item];
                })); else daysSpan.innerHTML = t.days;
                if (hoursSpan) if (hoursSpan.constructor.name == "NodeList") hoursSpan.forEach(((element, item) => {
                    element.innerHTML = ("0" + t.hours).slice(-2).split("")[item];
                })); else hoursSpan.innerHTML = ("0" + t.hours).slice(-2);
                if (minutesSpan) if (minutesSpan.constructor.name == "NodeList") minutesSpan.forEach(((element, item) => {
                    element.innerHTML = ("0" + t.minutes).slice(-2).split("")[item];
                })); else minutesSpan.innerHTML = ("0" + t.minutes).slice(-2);
                if (secondsSpan) if (secondsSpan.constructor.name == "NodeList") secondsSpan.forEach(((element, item) => {
                    element.innerHTML = ("0" + t.seconds).slice(-2).split("")[item];
                })); else secondsSpan.innerHTML = ("0" + t.seconds).slice(-2);
                if (t.total <= 0) {
                    ...
                    clock.querySelector("a").addEventListener("click", (e => {
                        let deadline = new Date(Date.parse(new Date) + 59 * 1e3);
        ...
        window.addEventListener("load", (e => {
            document.documentElement.addEventListener("click", (e => {
                if (typeof applicationSlider !== "undefined") applicationSlider.on("transitionEnd", (() => {
                    let deadline = new Date(Date.parse(new Date) + 59 * 1e3);
        ...
        window.addEventListener("resize", (() => {
            ...
            if (windowWidth >= 768) document.documentElement.classList.remove("menu-open");
        }));
        ...
        function hiddenTimeout() {
            ...
            for (const hiddenBlockTimeout of hiddenBlocksTimeout) {
                ...
                if (hiddenBlockTimeout.hasAttribute("data-from-slider")) applicationSlider.on("transitionEnd", (function() {
        ...
        function dataFilling(e = false) {
            ...
            for (let i = 0; i < Object.keys(dataUser).length; i++) {
                ...
                if (!e) if (elementsForm) elementsForm.forEach((e => {
            ...
            if (headerActionsBlock) if (dataUser.login == "true") headerActionsBlock.classList.add("header__actions_register"); else headerActionsBlock.classList.remove("header__actions_register");
        ...
        for (const form of allFormsPage) form.addEventListener("submit", (e => {
            setTimeout((() => {
                dataFilling(e);
            }), 100);
        }));
        const cabinetOut = document.querySelector(".cabinet-header__icon");
        if (cabinetOut) cabinetOut.addEventListener("click", (e => {
            e.preventDefault();
            const dataUser = JSON.parse(localStorage.getItem("fire-money"));
